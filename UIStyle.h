...
const QString LINE_EDIT_STYLE_SHEET =  "QLineEdit{padding: 5px 5px; font-size: 14px; font-weight: 400; font-family: Arial; color: black; background: #98FF98; border: 1px solid green; border-radius: 10px;}";

const QString PUSH_BUTTON_STYLE_SHEET = "QPushButton{border: none; outline: none; color: #000000; font-size: 14px;  font-family: Arial; font-weight: 600; background: #87CEEB;"
                                        "border-radius: 10%; padding: 7px 20px;}"\
...
const QString SCROLLBAR_STYLE_SHEET =   "QScrollBar:vertical {border: none; border-radius: 8px; background: #f0f0f0; width: 20px; }"\
                                        "QScrollBar::handle:vertical {border: none; background: #808c9c; min-height: 30px; border-radius: 8px; }"\
...
// const QString SCROLLBAR_STYLE_SHEET =   "QScrollBar:vertical { width: 20px; background: #f0f0f0; }"\
//                                       "QScrollBar::handle:vertical { background: #808c9c; min-height: 30px; border-radius: 8px; }"\
